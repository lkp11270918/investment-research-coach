...
export function ReviewPanel() {
  ...
  const reviewOutput = reviewResult?.state.agent_outputs.research_coach_review as BackendAgentOutput | undefined
  const doctrineOutput = reviewResult?.state.agent_outputs.firm_doctrine_case_retrieval as BackendAgentOutput | undefined
  ...
  const handleReview = async () => {
    ...
    try {
      ...
      const firstFinding = result.state.agent_outputs.research_coach_review?.findings?.[0]
