...
FINANCIAL_METRICS: tuple[FinancialMetricSpec, ...] = (
    ...
    FinancialMetricSpec("dividend", ("现金分红", "分红总额", "股利总额", "分红", "dividend"), "元"),
    FinancialMetricSpec("debt_to_asset_ratio", ("资产负债率", "debt to asset", "liability ratio"), "%"),
    FinancialMetricSpec("short_term_interest_bearing_debt", ("短期有息负债", "短期带息负债", "短期借款", "short-term debt"), "元"),
    FinancialMetricSpec("interest_bearing_debt", ("有息负债", "带息负债", "interest-bearing debt"), "元"),
    FinancialMetricSpec("interest_expense", ("利息费用", "财务费用中的利息支出", "interest expense"), "元"),
